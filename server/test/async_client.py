...
async def main():
    ...
    url = "http://localhost:8000/api/v1/chat/aa924cf7-7fe3-419f-b382-69ed3ada39bb" # get (use valid, else will get 404 page not found)
    # url = "http://localhost:8000/api/v1/chat/86f7e57c-ae58-4474-9c2a-b83383d6b4d3/delete" # delete (use valid, else will get 404 page not found)
    # url = "http://localhost:8000/api/v1/chat/aa924cf7-7fe3-419f-b382-69ed3ada39bb/update" # update (use valid, else will get 404 page not found)
